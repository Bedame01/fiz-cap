# CAPHAUS E-Commerce Platform Documentation
...
CAPHAUS is a modern, full-stack e-commerce platform specializing in premium caps and headwear. Built with Next.js 15, Supabase, and Stripe, it offers a seamless shopping experience with user authentication, shopping cart, secure checkout, and an admin dashboard.
...
| brand | text | Brand name (default: CAPHAUS) |
...
**Seeded Locations:**
- CAPHAUS Flagship (New York, NY)
- CAPHAUS LA (Los Angeles, CA)
- CAPHAUS Chicago (Chicago, IL)
- CAPHAUS Miami (Miami, FL)
