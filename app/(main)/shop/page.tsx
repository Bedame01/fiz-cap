...
export default async function ShopPage({ searchParams }: ShopPageProps) {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
      {/* Header */}
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mt-2 mb-8">
        <div>
          <h1 className="text-4xl font-medium tracking-tight text-foreground textDisplay">{title}</h1>
